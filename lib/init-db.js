...
END $$;
DO $$ BEGIN
  ALTER TABLE tp_reviews ADD COLUMN is_hidden BOOLEAN DEFAULT false;
EXCEPTION WHEN duplicate_column THEN NULL;
END $$;
DO $$ BEGIN
  ALTER TABLE tp_reviews ADD COLUMN edited_content TEXT DEFAULT NULL;
EXCEPTION WHEN duplicate_column THEN NULL;
END $$;
DO $$ BEGIN
  ALTER TABLE tp_reviews ADD COLUMN is_pinned BOOLEAN DEFAULT false;
EXCEPTION WHEN duplicate_column THEN NULL;
END $$;
`;
